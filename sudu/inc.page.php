...
$data[] = 'ajax'; $data[] = 'id'; $data[] = 'cmd'; $data[] = 'oid';//common paras used by each page
$arr = array();
foreach ($data as $k) $arr[$k] = isset($_POST[$k]) ? $_POST[$k] : (isset($_GET[$k]) ? $_GET[$k] : null);
$data = $arr;
...
sidu_init($SIDU, $data);
$SIDU['data'] = $data;
$conn = isset($SIDU['conn'][$SIDU[0]]) ? $SIDU['conn'][$SIDU[0]] : array(); // shortcut as most page use it
include 'inc.lang.'. $SIDU['page']['lang'] .'.php';

$SIDU['sidu_ver'] = '6.1'; // released 2019-09-09
function SIDU_PK(){return '2019-SIDU-0909';} // SIDU Product Key - please update
